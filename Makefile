...
RoboQuest-Linux-Debug:
	 $(PROJECTBUILD) RoboQuest Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

RoboQuest-Linux-DebugGame:
	 $(PROJECTBUILD) RoboQuest Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

RoboQuest-Linux-Shipping:
	 $(PROJECTBUILD) RoboQuest Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

RoboQuest-Linux-Test:
	 $(PROJECTBUILD) RoboQuest Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

RoboQuest:
	 $(PROJECTBUILD) RoboQuest Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

RoboQuestEditor-Linux-Debug:
	 $(PROJECTBUILD) RoboQuestEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

RoboQuestEditor-Linux-DebugGame:
	 $(PROJECTBUILD) RoboQuestEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

RoboQuestEditor-Linux-Shipping:
	 $(PROJECTBUILD) RoboQuestEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

RoboQuestEditor-Linux-Test:
	 $(PROJECTBUILD) RoboQuestEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

RoboQuestEditor:
	 $(PROJECTBUILD) RoboQuestEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
