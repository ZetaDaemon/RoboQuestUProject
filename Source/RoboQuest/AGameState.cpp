...
AAGameState::AAGameState(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
    ...
    this->StatManager = CreateDefaultSubobject<UAStatManager>(TEXT("StatManager"));
    this->bGameStateGenerator = false;
    this->LevelGeneratorRef = NULL;
    this->DT_Levels = NULL;
    this->MarkRatioMultiplier = 1.00f;
    this->DT_Enemy = NULL;
    this->DT_Ally = NULL;
    this->DT_EnemyDeath = NULL;
    this->EliteLootTicketLuckModifier = 0;
    this->bHitFeedbackDisabled = false;
    this->ShootingRangeLayer = NULL;
    this->PickupClassesLoaded[0] = NULL;
    this->PickupClassesLoaded[1] = NULL;
    this->PickupClassesLoaded[2] = NULL;
    this->PickupClassesLoaded[3] = NULL;
    this->PickupClassesLoaded[4] = NULL;
    this->PickupClassesLoaded[5] = NULL;
    this->PickupClassesLoaded[6] = NULL;
    this->PickupClassesLoaded[7] = NULL;
    this->PickupClassesLoaded[8] = NULL;
    this->PickupClassesLoaded[9] = NULL;
    this->PickupClassesLoaded[10] = NULL;
    ...
    this->MultiplayerTimePickupValue = 0.00f;
    ...
    this->PickupLifetimeModifier[0] = 0.00f;
    this->PickupLifetimeModifier[1] = 0.00f;
    this->PickupLifetimeModifier[2] = 0.00f;
    this->PickupLifetimeModifier[3] = 0.00f;
    this->PickupLifetimeModifier[4] = 0.00f;
    this->PickupLifetimeModifier[5] = 0.00f;
    this->PickupLifetimeModifier[6] = 0.00f;
    this->PickupLifetimeModifier[7] = 0.00f;
    this->PickupLifetimeModifier[8] = 0.00f;
    this->PickupLifetimeModifier[9] = 0.00f;
    this->PickupLifetimeModifier[10] = 0.00f;
    this->PickupRangeRatio = 1.00f;
    this->HealthPickupValueModifier = 0.00f;
    this->PlayerLevel = 0;
    this->DT_Weapons = NULL;
    this->InteractiveWeaponClass = NULL;
    this->WeaponPickupValueModifier = 0;
    this->DT_Crystals = NULL;
    this->DT_Items = NULL;
    this->DT_BazarItems = NULL;
    this->BazarItemCostReduction = 0;
    this->InteractiveItemClass = NULL;
    this->DT_HitSurface = NULL;
    this->DT_LocomotionSurface = NULL;
    this->GameTime = 0.00f;
    this->GameTimeOnLevelStart = 0.00f;
    this->TotalRunTime = 0.00f;
    this->bGameTimePaused = true;
    this->WeaponCardClass = NULL;
    this->EnemyCardClass = NULL;
    this->CustomProjectileMaxPoolSize = 20;
    this->ProjectileDestroyLifeSpan = 0.15f;
    this->DT_MetaRewardBoard = NULL;
    this->DT_GameTips = NULL;
    this->DT_Difficulty = NULL;
    this->DT_StoryCapsule = NULL;
    this->BaseBasecampLayer = NULL;
    this->CurrentBasecampLayerLevel = NULL;
    this->MaxClass = NULL;
    this->MPC_Borealis = NULL;
    this->GameModeRef = NULL;
    this->GameInstanceRef = NULL;
    this->DT_LevelGeneratorMutator = NULL;
    this->bDeactivateHealbot = false;
    this->HealbotCost = 0;
    this->CorruptedCellPercent = 0;
    this->MaxItemInChest = 0;
    this->TrapAddDamagePercent = 0.00f;
    this->bTimeLimitationMutator = false;
    this->BattleWorkerAmount = 0;
    this->BattleWorkerSpawnDelay = 0.00f;
    this->MutatorEnemyExplosionPreshotSoundLoaded = NULL;
    this->MutatorEnemyExplosionTriggerSoundLoaded = NULL;
    this->MutatorEnemyExplosionFXLoaded = NULL;
}
